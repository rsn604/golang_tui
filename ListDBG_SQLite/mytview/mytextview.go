...
// MyTextView is a box which displays text. It implements the io.Writer interface
...
//
// See https://github.com/kubemq-hub/tview/wiki/MyTextView for an example.
...
// NewMyTextView returns a new text view.
...
func (t *MyTextView) SetScrollable(scrollable bool) *MyTextView {
...
func (t *MyTextView) SetWrap(wrap bool) *MyTextView {
	if t.wrap != wrap {
		t.index = nil
	}
	t.wrap = wrap
...
func (t *MyTextView) SetWordWrap(wrapOnWords bool) *MyTextView {
...
func (t *MyTextView) SetTextAlign(align int) *MyTextView {
	if t.align != align {
		t.index = nil
	}
	t.align = align
...
func (t *MyTextView) SetTextColor(color tcell.Color) *MyTextView {
	t.textColor = color
	return t
}
...
func (t *MyTextView) SetText(text string) *MyTextView {
	t.Clear()
	fmt.Fprint(t, text)
	return t
}
...
func (t *MyTextView) GetText(stripAllTags bool) string {
	// Get the buffer.
...
func (t *MyTextView) SetDynamicColors(dynamic bool) *MyTextView {
...
func (t *MyTextView) SetRegions(regions bool) *MyTextView {
...
//   - You can call MyTextView.HasFocus() from this handler.
...
func (t *MyTextView) SetChangedFunc(handler func()) *MyTextView {
	t.changed = handler
	return t
}
...
// handler.
func (t *MyTextView) SetDoneFunc(handler func(key tcell.Key)) *MyTextView {
	t.done = handler
	return t
}
...
func (t *MyTextView) SetHighlightedFunc(handler func(added, removed, remaining []string)) *MyTextView {
	t.highlighted = handler
	return t
}

// ScrollTo scrolls to the specified row and column (both starting with 0).
func (t *MyTextView) ScrollTo(row, column int) *MyTextView {
	if !t.scrollable {
		return t
	}
	t.lineOffset = row
...
// is scrollable.
func (t *MyTextView) ScrollToBeginning() *MyTextView {
	if !t.scrollable {
		return t
	}
	t.trackEnd = false
...
func (t *MyTextView) ScrollToEnd() *MyTextView {
	if !t.scrollable {
		return t
	}
	if !t.trackOff {
...
func (t *MyTextView) GetScrollOffset() (row, column int) {
	return t.lineOffset, t.columnOffset
}

// Clear removes all text from the buffer.
func (t *MyTextView) Clear() *MyTextView {
	t.buffer = nil
	t.recentBytes = nil
	t.index = nil
	return t
...
func (t *MyTextView) Highlight(regionIDs ...string) *MyTextView {
	// Toggle highlights.
...
func (t *MyTextView) GetHighlights() (regionIDs []string) {
...
func (t *MyTextView) SetToggleHighlights(toggle bool) *MyTextView {
...
// not scrollable.
func (t *MyTextView) ScrollToHighlight() *MyTextView {
...
// is returned.
func (t *MyTextView) GetRegionText(regionID string) string {
...
func (t *MyTextView) Focus(delegate func(p tview.Primitive)) {
...
func (t *MyTextView) HasFocus() bool {
...
// as a new line.
func (t *MyTextView) Write(p []byte) (n int, err error) {
	// Notify at the end.
	t.Lock()
	changed := t.changed
	t.Unlock()
...
func (t *MyTextView) reindexBuffer(width int) {
	if t.index != nil {
...
func (t *MyTextView) Draw(screen tcell.Screen) {
	t.Lock()
	defer t.Unlock()
	t.Box.Draw(screen)
...
func (t *MyTextView) InputHandler() func(event *tcell.EventKey, setFocus func(p tview.Primitive)) {
...
func (t *MyTextView) MouseHandler() func(action tview.MouseAction, event *tcell.EventMouse, setFocus func(p tview.Primitive)) (consumed bool, capture tview.Primitive) {
